		...
		<div class="row site-content">
			...
			<aside class="col-md-3 sidebar widget-area">
				...
				<div class="widget widget-products">
					...
					<ul class="widget-nimi-product">
						<?php for ($i=0; $i < 3 ; $i++) { ?>
							...
							<a href="#"><img src="images/assets/mini-prod.png" alt=""></a>						
				...
				<div class="widget widget-banner">
					<img src="images/assets/w-banner.png" alt="">
			...
			<div class="col-md-9 content-area">
				...
				<div class="banners">
					...
					<div class="big-banner">
						<img src="images/assets/big-banner.png" alt="">
					...
					<div class="row mini-banners">
						<div class="col-md-6 mini-banner">
							<a href="#"><img src="images/assets/banner.png" alt=""></a>
				...
				<div class="row products">
					...
					<?php for ($i=0; $i < 8; $i++) { ?>
						...
						<!-- product-photo -->
						<a href="#" class="product-img"><img src="images/assets/pr.png" alt=""></a>
						<!--emd product-photo -->
				...
				<div class="row advert-banner">
					<div class="col-md-6 advert">
						<a href="#"><img src="images/assets/advert-banner.png" alt=""></a>
					</div>
					<div class="col-md-6 advert">
						<a href="#"><img src="images/assets/advert-banner.png" alt=""></a>
					</div>					
