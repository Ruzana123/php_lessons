							...
							if(!empty($_GET['id_category'])){
								...
								if ($todo[marker]==1){?>
						 		<li class="list-group-item" style="text-decoration:line-through">
								    ...
								    <?php echo $todo[todo]; ?>
								    <div class="todo-btn" style="float:right; margin-right: 10px;">
								...
								<?php } ?>
										<a href="<?php echo get_url_post("delete",'id',$todo['id']). '&category=' . $_GET['id_category']; ?>" style="color:blue; text-decoration:none"><span class="glyphicon glyphicon-remove" aria-hidden="true"></a>
						 				<a href="<?php echo get_url_post("edit_task_name",'id',$todo['id']). '&category=' . $_GET['id_category']; ?>" style="color:blue; text-decoration:none; float:right;"><span class="glyphicon glyphicon-pencil" style="margin-left: 10px;" aria-hidden="true"></a>
						 			</div>
								 </li> <?php
									}
									?>
